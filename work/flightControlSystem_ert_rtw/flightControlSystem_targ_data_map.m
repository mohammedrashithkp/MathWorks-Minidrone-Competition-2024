    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fhyssyahxd
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.flnfhkxd4v
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.hdf3hwphqe
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.pn5ohbycrm
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.b0lhxwtg1j
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.c5smi5p5av
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fv3105nezg
                    section.data(2).logicalSrcIdx = 4;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.pbw3t0i3cp
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.oervgftr1f
                    section.data(1).logicalSrcIdx = 7;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.ozhtspm20y
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.ozmb3qzd5m
                    section.data(4).logicalSrcIdx = 12;
                    section.data(4).dtTransOffset = 3;

                    ;% cjyyyt0pe2y.ckvsxbn4sk
                    section.data(5).logicalSrcIdx = 13;
                    section.data(5).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.mbg0vsgjdr
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ex0o0steyq
                    section.data(5).logicalSrcIdx = 20;
                    section.data(5).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.cn4wuvf5ut
                    section.data(6).logicalSrcIdx = 21;
                    section.data(6).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.n1qe4zbtki
                    section.data(7).logicalSrcIdx = 22;
                    section.data(7).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.h451ndhxdh
                    section.data(8).logicalSrcIdx = 23;
                    section.data(8).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.eo2igg1vne
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.erxflqsrbk.LoggedData
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.h0uxjxqzty
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.gttixxz1a1
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.no5xztoitb
            ...
            section.data(12)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ive2ljtkb2
    ...
    targMap.checksum0 = 3050269864;
    targMap.checksum1 = 976128954;
    targMap.checksum2 = 2148292805;
    targMap.checksum3 = 897530101;
